...
################################################################
# This is a generated script based on design: zc706_axis_io
#
...
# source zc706_axis_io_script.tcl
...
CONFIG.PCW_WDT_WDT_IO.VALUE_SRC {DEFAULT} \
  ...
  # Create instance: psr1, and set properties
  set psr1 [ create_bd_cell -type ip -vlnv xilinx.com:ip:proc_sys_reset:5.0 psr1 ]

  # Create instance: stream_fifo, and set properties
  set stream_fifo [ create_bd_cell -type ip -vlnv xilinx.com:ip:axis_data_fifo:1.1 stream_fifo ]
  set_property -dict [ list \
...
CONFIG.TDATA_NUM_BYTES {4} \
  ...
  connect_bd_net -net binary_counter_Q [get_bd_pins binary_counter/Q] [get_bd_pins stream_fifo/s_axis_tdata]
  connect_bd_net -net irq_concat_dout [get_bd_pins irq_concat/dout] [get_bd_pins ps7/IRQ_F2P]
  connect_bd_net -net one_dout [get_bd_pins one/dout] [get_bd_pins stream_fifo/s_axis_tvalid]
  connect_bd_net -net processing_system7_0_FCLK_CLK0 [get_bd_pins binary_counter/CLK] [get_bd_pins ps7/FCLK_CLK0] [get_bd_pins psr0/slowest_sync_clk] [get_bd_pins stream_fifo/s_axis_aclk]
  connect_bd_net -net processing_system7_0_FCLK_CLK1 [get_bd_pins ps7/FCLK_CLK1] [get_bd_pins psr1/slowest_sync_clk] [get_bd_pins stream_fifo/m_axis_aclk]
  connect_bd_net -net processing_system7_0_FCLK_RESET0_N [get_bd_pins ps7/FCLK_RESET0_N] [get_bd_pins psr0/ext_reset_in] [get_bd_pins psr1/ext_reset_in]
  connect_bd_net -net psr0_peripheral_aresetn [get_bd_pins psr0/peripheral_aresetn] [get_bd_pins stream_fifo/s_axis_aresetn]
  connect_bd_net -net psr1_peripheral_aresetn [get_bd_pins psr1/peripheral_aresetn] [get_bd_pins stream_fifo/m_axis_aresetn]
...
preplace inst one -pg 1 -lvl 3 -y 290 -defaultsOSRD
preplace inst ps7 -pg 1 -lvl 2 -y 220 -defaultsOSRD
preplace inst stream_fifo -pg 1 -lvl 4 -y 370 -defaultsOSRD
preplace inst psr0 -pg 1 -lvl 3 -y -80 -defaultsOSRD
preplace inst psr1 -pg 1 -lvl 3 -y 80 -defaultsOSRD
preplace inst binary_counter -pg 1 -lvl 3 -y 370 -defaultsOSRD
preplace inst irq_concat -pg 1 -lvl 1 -y 220 -defaultsOSRD
preplace netloc processing_system7_0_DDR 1 2 3 580J 170 NJ 170 NJ
preplace netloc one_dout 1 3 1 900J
preplace netloc processing_system7_0_FCLK_RESET0_N 1 2 1 560
preplace netloc binary_counter_Q 1 3 1 920J
preplace netloc processing_system7_0_FIXED_IO 1 2 3 550J 190 NJ 190 NJ
preplace netloc psr1_peripheral_aresetn 1 3 1 910
preplace netloc psr0_peripheral_aresetn 1 3 1 930
preplace netloc processing_system7_0_FCLK_CLK0 1 2 2 570 230 890
preplace netloc irq_concat_dout 1 1 1 180
preplace netloc processing_system7_0_FCLK_CLK1 1 2 2 590 430 NJ
levelinfo -pg 1 0 100 370 740 1120 1320 -top -160 -bot 570
",
}
